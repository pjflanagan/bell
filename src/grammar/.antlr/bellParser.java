...
public class bellParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, T__2=3, URL=4, ID=5, NUMBER=6, WS=7;
	public static final int
		RULE_program = 0, RULE_sourceElement = 1, RULE_sourceElements = 2, RULE_statement = 3, 
		RULE_urlStatement = 4, RULE_paramStatement = 5, RULE_logStatement = 6;
	private static String[] makeRuleNames() {
		return new String[] {
			"program", "sourceElement", "sourceElements", "statement", "urlStatement", 
			"paramStatement", "logStatement"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, null, "URL", "ID", "NUMBER", "WS"
		};
	}
	...
	public final UrlStatementContext urlStatement() throws RecognitionException {
		...
		enterRule(_localctx, 8, RULE_urlStatement);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(31);
	...
	public final ParamStatementContext paramStatement() throws RecognitionException {
		...
		enterRule(_localctx, 10, RULE_paramStatement);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(34);
